...
>
	<span class="block text-sm text-gray-500 text-left sm:text-center dark:text-gray-400"
		>© {new Date().getFullYear()}
		<a href="https://craftlab.ai" target="_blank" class="hover:underline">Meta Craftlab</a> All Rights
		Reserved.</span
	>
